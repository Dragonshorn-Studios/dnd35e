...
import { SpecificRegionBehavior } from "../region-behaviour/types";
import { SceneDnd35e } from "../SceneDnd35e";
...
interface RegionDocumentDnd35e<TParent extends SceneDnd35e | null = SceneDnd35e | null> extends RegionDocument<TParent> {
    readonly behaviors: EmbeddedCollection<SpecificRegionBehavior<this>>;

    get object(): foundry.canvas.placeables.Region<this>;
}
